...
//class for the database functions


public class DatabaseHelper {

    public static final String TAG = DatabaseHelper.class.getSimpleName(); //getting the tag name

    private static DatabaseHelper instance; //creating an instance
