...
import com.FitAlly.MyFitAllyApp.base.BaseView;
import com.FitAlly.MyFitAllyApp.pickImageBase.PickImagePresenter;
...
//        profileManager = ProfileManager.getInstance(context.getApplicationContext());
    ...
    void onUpdateAccount(View anchorView) {
        if (checkInternetConnection(anchorView)) {

            ifViewAttached(EditProfileView:: updateAccount);
        }
    }
    void DataToFirebase() {
        ifViewAttached(EditProfileView:: sendDataToFirebase);
    }
    void saveImage() {
        ifViewAttached(EditProfileView:: saveImageToFirebase);
    }
...
//        });
    ...
    protected void onProfileUpdatedSuccessfully() { ifViewAttached(BaseView::finish); //if it has updated, implement the interface function created from the BaseActivity to indicate it has finished.
    }
