...
package com.FitAlly.MyFitAllyApp.base;
...
//main functino of this class is to build functions that will keep getting used within the whole application, such as mainly warning messages and error validations.
