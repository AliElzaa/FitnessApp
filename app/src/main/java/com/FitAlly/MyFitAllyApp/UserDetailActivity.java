...
public class UserDetailActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void openDialogCreateGroup() { //this dialog opens to create a group
       ...
       CircleImageView circleImageClose=vw.findViewById(R.id.imgClose);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() { //once the 'create competition' button is clicked, is opened then it will save the name and create it.
            @Override
            public void onClick(View view) {
                ...
                {
                    sendDataToFirebase(groupname); //calls the function to send it to firebase/
                }
            }
        });
    }
...
//        groupMap.put("userType","admin");
    ...
    private void RetreiveUserInfo() { //this will retrieve the user data, and add the new information of the group
        ...
        databaseReference.child("profiles").child(userID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if ((dataSnapshot.exists())&&(dataSnapshot.hasChild("first"))&&(dataSnapshot.hasChild("photoUrl")))//if the user has created account or not
                {
                    ...
                    groupMap.put("weightdifference_first",String.valueOf(Double.parseDouble(current_weight)-Double.parseDouble(target)));
                    createCompetition();
                ...
                {
                    Toast.makeText(UserDetailActivity.this, "User not active,complete profile", Toast.LENGTH_SHORT).show(); //if there is any error such as the user not existing or them having missing profile information, it will show a dialog
                }
