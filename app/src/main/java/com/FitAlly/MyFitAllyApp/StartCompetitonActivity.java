...
Button btn_next;
    ...
    Spinner spinner;
    public String[] amountsarray = {"£2","£5","£10","£15"}; //array to hold the amounts
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item,amountsarray); //creating a drop down list with the array values
        //adapter.setDropDownViewResource(R.layout.text);
        spinner.setAdapter(adapter);
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) { //to check if a user has selected an option, there is a iteration going along matching the number with the amount
        ...
        switch (view.getId())
        {
            case R.id.btn_next:
                ...
                if (charity!=null    )
                {
                    ...
                    Intent intent=new Intent(StartCompetitonActivity.this, AddUsersActivity.class);
