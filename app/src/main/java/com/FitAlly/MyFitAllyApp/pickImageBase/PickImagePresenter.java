...
import com.FitAlly.MyFitAllyApp.Utils.ValidationUtil;
import com.FitAlly.MyFitAllyApp.base.BasePresenter;
...
public class PickImagePresenter<V extends PickImageView> extends BasePresenter<V> {
    ...
    public PickImagePresenter(Context context) {
        super(context);
    }//INherit the function from the class

    public boolean isImageFileValid(Uri imageUri) { //checking if the image is valid
